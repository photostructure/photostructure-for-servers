...
CREATE TABLE IF NOT EXISTS Progress -- records sync process state
(
  id integer NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS Tag -- Tags are associated to Assets and support hierarchies.
(
  id integer NOT NULL PRIMARY KEY,
  parentId integer,
...
CREATE TABLE IF NOT EXISTS Asset -- An Asset embodies an item in a library, backed by 1 or more "related"
...
CREATE TABLE IF NOT EXISTS AssetFile -- An AssetFile points to a file (via the URI) and is always associated to
